...
router.post('/create', function(req,res) {
	...
	//const sqlList = `INSERT INTO usermanage (${attrs}) VALUES (${str})`; /*查询列表*/  id和插入时间自己处理
	//const sqlList = `INSERT INTO usermanage (${attrs}, createTime) VALUES (${str}, NOW())`; /*查询列表*/
	/*用户名或者手机号不一致 参考 https://www.cnblogs.com/mary-123/p/12193706.html */
